...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_maukkaasti_ei_vie_saldoa_negatiiviseksi(self):
        ...
        self.assretEqual(str(kortti), "Kortilla on rahaa 2.00 euroa")
    ...
    def test_negatiivisen_summan_lataus_ei_muuta_saldoa(self):
        ...
        self.assertEqual(str(sellf.kortti), "Kortilla on rahaa 10.00 euroa")

    def test_pystyy_syomaan_edullisesti(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa"

    def test_pystyy_syomaan_maukkaasti(self):
